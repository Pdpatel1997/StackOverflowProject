...
namespace StackOverflowProject.ServiceLayer
{
    public interface IUsersService
    {
        ...
        UserViewModel GetUsersByUserID(int uid);
    }
    public class UsersService : IUsersService
    {
        ...
        {
            MapperConfiguration config = new MapperConfiguration(cfg => { cfg.CreateMap<RegisterViewModel, User>(); cfg.IgnoreUnmapped(); });
       ...
       public void UpdateUserDetails(EditUserDetailsViewModel uvm)
        {
            MapperConfiguration config = new MapperConfiguration(cfg => { cfg.CreateMap<EditUserDetailsViewModel, User>(); cfg.IgnoreUnmapped(); });
            IMapper mapper = config.CreateMapper();
        ...
        {
            MapperConfiguration config = new MapperConfiguration(cfg => { cfg.CreateMap<EditUserPasswordViewModel, User>(); cfg.IgnoreUnmapped(); });
            IMapper mapper = config.CreateMapper();
        ...
        public List<UserViewModel> GetUsers()
        {
            ...
            MapperConfiguration config = new MapperConfiguration(cfg => { cfg.CreateMap<User, UserViewModel>(); cfg.IgnoreUnmapped(); });
            IMapper mapper = config.CreateMapper();
        ...
        public UserViewModel GetUsersByUserID(int uid)
        {
            User u = ur.GetUsersByUSerID(uid).FirstOrDefault();
            UserViewModel uvm = null;
            if (u != null)
            {
